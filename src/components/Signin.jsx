...
const Signin = () => {
  ...
  async function submit(data) {
    ...
    try {
      let res = await api.post("/api/auth/signin", data, {
      ...
      <div className="box bg-white lg:w-[35vw] border-2 rounded-lg flex flex-col items-center py-10 mx-2 md:mx-4">
        ...
        <form onSubmit={handleSubmit(submit)} className="flex flex-col w-4/5">
          <p className="pt-2 text-center">
            Signin to access all your favorite features of our app
          </p>
          <label htmlFor="email" className="mt-5 mb-1 font-semibold text-sm">
            Email
          </label>
          <input
